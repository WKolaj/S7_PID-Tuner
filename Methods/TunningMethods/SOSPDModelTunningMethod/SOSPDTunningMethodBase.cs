...
namespace SOSPDModelTunningMethod
{
    ...
    public abstract class SOSPDTunningMethodBase
    {
        ...
        public SOSPDTunningMethodBase(TunningType typeOfTuning, PIDModeType typeOfAlgorithm, String name, Boolean rootsRequired)
        {
