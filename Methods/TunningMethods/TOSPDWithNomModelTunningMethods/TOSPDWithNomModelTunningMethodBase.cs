...
namespace TOSPDWithNomModelTunningMethods
{
    ...
    public abstract class TOSPDWithNomModelPITunningMethod
    {
        ...
        public TOSPDWithNomModelPITunningMethod(TunningType typeOfTuning, PIDModeType typeOfAlgorithm, String name)
        {
