...
{
    /// <summary>
    /// Klasa zmiennej typu Int16
    /// </summary>
    public class Int16Variable : VariableBase
    {
        /// <summary>
        /// Konstruktor klasy zmiennej typu Int16
        /// </summary>
        /// <param name="Name">
        /// Nazwa zmiennej
        /// </param>
        ...
        /// </param>
        public Int16Variable(string Name, Connection connectionObject, MemoryType memoryType, int areaBegining, Object commonLockingObject, int dataBlockNumber = 0) :
        ...
        {
            Value = connection.libnodaveConnection.getS16();
        }
    }
}
